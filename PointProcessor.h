 ...
 *
 *
 * A class containing implementations (done ahead of time) of various point processes. 
 * Some of them were written by us for the previous assignment, and some are simple 
...
class PointProcessor : public QObject
{
  ...
  public slots:
   ...
   bool PointProcessor::Menu_PointProcesses_EqualizeWithClipping(Image& image);
